...
//print_r($result);
printf("今天是%s，广州今日%s，体感温度%s℃，气压%s毫巴，相对湿度%s，能见度%s公里，%s%skm/s \n",date("m月d日"),$result->phrase,$result->feelsLike,$result->altimeter,$result->humidity,$result->visibility,$result->windDirCompass,$result->windSpeed)
?>